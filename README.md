...
<img src="docs/logo.png" width="192" alt="TwinHouse logo" />
...
# backend
cd backend
conda create -n TwinHouse python=3.11 -y && conda activate TwinHouse   # or: python -m venv .venv
