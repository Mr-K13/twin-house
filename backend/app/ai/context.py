"""Condense TwinState into an operations summary that an LLM can read (kept at ~3k tokens). Copilot and VLM share it."""
...
def robots_near(S: dict[str, Any], layout: dict[str, Any], camera_id: str) -> dict[str, Any]:
    """Auxiliary context for the VLM: what is in the camera view (rough check: same zone and distance < range)."""
