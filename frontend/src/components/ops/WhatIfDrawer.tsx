/**
 * What-if Simulation drawer (spec 1️⃣7️⃣ / Demo 08)
 *  ☑ scenario → Duration → RUN → the backend copies the LIVE engine and runs Baseline and Scenario → comparison table / key events / AI recommendation
 *  "Apply to LIVE" sends the same set of injections to LIVE.
 */
