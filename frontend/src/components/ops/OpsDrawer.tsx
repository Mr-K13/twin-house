/**
 * AI Operations drawer (Phase 4: explainable decisions + KPI; Phase 5 adds the Copilot chat on top)
 * Spec 2️⃣5️⃣: do not only say "select R04"; list the ✓ reasons and the reasons for each rejected robot.
 */
