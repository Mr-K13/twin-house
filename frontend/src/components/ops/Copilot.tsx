/**
 * AI Operations Copilot chat (spec 1️⃣6️⃣)
 * online: COPILOT_ASK → backend LLM (or rule-based fallback) → COPILOT_REPLY; citations (R03 / A3812 / E123) are clickable.
 * local: show a notice when there is no backend.
 */
...
export function Copilot() {
  ...
  const ask = (question: string) => {
    ...
    // Replace "next waiting task" with the actual task id, so that the answer can cite it
