...
export function People({ lite = false }: { lite?: boolean }) {
  ...
  // Phase 1: a few fixed workers in high-visibility vests and one forklift (floor 1 decoration) make the scene feel alive
  // round-9d: all decorative workers move into the maintenance area (RESTRICT-1, a blocked area that robots cannot enter) -- they no longer stand next to aisles/charging rows where robots pass close by
