/** Task location rules (same as backend/app/sim/rules.py): locations must exist, must not be charging stations, must differ, and must match the TaskType. */
...
/** Return an error message; null = valid. */
